...
@section('title', 'Lista de Coodenadoras')
...
<body class="bg-gray-300">
    ...
    <h2 class="text-2xl font-bold mb-6 text-bleck-500 text-center">LISTA DE COORDENADORAS</h2>

    <!-- Botão -->
    <div class="flex justify-center">
        <a href="{{ route('coordenadoras.criar') }}"
    ...
    <table class="w-full table-auto border-collapse mt-4">
        ...
        <tbody>
            @foreach($coordenadoras as $coordenadora)
            <tr class="hover:bg-gray-100">
                <td class="border-b px-4 py-2 text-sm text-gray-700 text-center">{{ $coordenadora->id }}</td>
                <td class="border-b px-4 py-2 text-sm text-gray-700 text-center">{{ $coordenadora->nome}}</td>
                <td class="border-b px-4 py-2 text-sm text-gray-700 text-center"><!-- Exemplo na View de Exibição -->
                    ...
                    @endif</td>
                <td class="border-b px-4 py-2 text-sm text-gray-700 text-center">{{ $coordenadora->formacao_graduacao}}</td>
                <td class="border-b px-4 py-2 text-sm text-gray-700 text-center">{{ $coordenadora->turno_que_trabalha}}</td>
