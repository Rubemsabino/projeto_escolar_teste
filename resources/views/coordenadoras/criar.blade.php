...
@section('title', 'Criar Coordenadora')
...
<h2 class="text-2xl font-bold mb-6 text-gray-500 text-center">NOVO COORDENADOR</h2>

<form action="{{ route('professores.salvar') }}" method="POST" enctype="multipart/form-data"
