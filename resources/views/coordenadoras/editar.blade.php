...
@section('title', 'Editar Coordenadora')
...
<h2 class="text-2xl font-bold mb-6 text-gray-500 text-center">EDITAR COORDENADORA</h2>

<form action="{{ route('coordenadoras.atualizar', $coordenadora->id) }}" method="POST" class="flex-1 overflow-y-auto p-4">
    @csrf
    @method('PUT')
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" id="matricula" name="matricula"
                    ...
                    value="{{($coordenadora->id)}}" readonly>
            </div>
            <div>
                ...
                <div class="flex items-center space-x-8 mb-4">
                    ...
                    @if($coordenadora->foto == 'sem_foto')
                    <p>SEM FOTO</p>
                    @else
                    <img src="{{ asset('storage/' . $coordenadora->foto) }}" alt="Foto do Aluno"
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-6 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="text" id="nome" name="nome"
                    ...
                    placeholder="Digite seu nome completo" value="{{($coordenadora->nome)}}">
            </div>
            ...
            <div>
                ...
                <input type="date" id="data_de_nascimento" name="data_de_nascimento"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    onchange="calcularIdade()" value="{{($coordenadora->data_de_nascimento)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="idade" name="idade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Só números" value="{{($coordenadora->idade)}}">
            </div>
            ...
            <div>
                ...
                <select id="sexo" name="sexo"
                    ...
                    <option value="masculino" @selected($coordenadora->sexo == 'masculino')>Masculino</option>
                    <option value="feminino" @selected($coordenadora->sexo == 'feminino')>Feminino</option>
                    <option value="outros" @selected($coordenadora->sexo == 'outros')>Outros</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="text" id="cpf" name="cpf"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Só números" value="{{($coordenadora->cpf)}}">
            </div>
        </div>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" id="rg" name="rg"
                    ...
                    placeholder="Só números" value="{{($coordenadora->rg)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="naturalidade" name="naturalidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Digite a cidade" value="{{($coordenadora->naturalidade)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="nacionalidade" name="nacionalidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Automático" value="{{($coordenadora->nacionalidade)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="celular" name="celular"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100 focus:border-red-500"
                    placeholder="Só números" oninput="mascaraCelular(this)" value="{{($coordenadora->celular)}}">
            </div>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-6 gap-4">
            <div>
                ...
                <input type="text" id="cep" name="cep"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Só números" value="{{($coordenadora->cep)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="rua" name="rua"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Automático" value="{{($coordenadora->rua)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="numero" name="numero"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Só números" value="{{($coordenadora->numero)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="bairro" name="bairro"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Automático" value="{{($coordenadora->bairro)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="cidade" name="cidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Automático" value="{{($coordenadora->cidade)}}">
            </div>
            ...
            <div>
                ...
                <input type="text" id="estado" name="estado"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    placeholder="Automático" value="{{($coordenadora->estado)}}">
            </div>
        </div>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="date" id="data_de_admissao" name="data_de_admissao"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->data_de_admissao)}}">
            </div>
    ...
    <div class="flex flex-col sm:flex-row justify-center gap-2">
        ...
        <a href="{{ route('coordenadoras.ver', $coordenadora->id)}}"
