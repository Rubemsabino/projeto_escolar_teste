...
@section('title', 'Ver Coordenadora')
...
<h2 class="text-2xl font-bold mb-6 text-gray-500 text-center">VER COORDENADORA</h2>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-6 gap-4">
            <div class="md:col-span-2">
                ...
                <input type="text" id="nome" name="nome"
                    ...
                    value="{{($coordenadora->nome)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="data_de_nascimento" name="data_de_nascimento"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-yellow-100"
                    value="{{ $coordenadora->data_de_nascimento ? \Carbon\Carbon::parse($coordenadora->data_de_nascimento)->format('d/m/Y') : '' }}"
                    readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="idade" name="idade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->idade)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="sexo" name="sexo"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-yellow-100"
                    value="{{($coordenadora->sexo)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="cpf" name="cpf"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->cpf)}}" readonly>
            </div>
        </div>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input type="text" id="rg" name="rg"
                    ...
                    value="{{($coordenadora->rg)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="naturalidade" name="naturalidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->naturalidade)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="nacionalidade" name="nacionalidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->nacionalidade)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="celular" name="celular"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100 focus:border-red-500"
                    value="{{($coordenadora->celular)}}" readonly>
            </div>
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-6 gap-4">
            <div>
                ...
                <input type="text" id="cep" name="cep"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->cep)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="rua" name="rua"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->rua)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="numero" name="numero"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->numero)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="bairro" name="bairro"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->bairro)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="cidade" name="cidade"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->cidade)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="estado" name="estado"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->estado)}}" readonly>
            </div>
        </div>
    ...
    <fieldset class="border border-gray-400 p-4 rounded-lg">
        ...
        <div class="mb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <input type="text" id="estado" name="estado"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->formacao_graduacao)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="turno_que_trabalha" name="turno_que_trabalha"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->turno_que_trabalha)}}" readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="data_de_admissao" name="data_de_admissao"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-yellow-100"
                    value="{{ $coordenadora->data_de_admissao ? \Carbon\Carbon::parse($coordenadora->data_de_admissao)->format('d/m/Y') : '' }}"
                    readonly>
            </div>
            ...
            <div>
                ...
                <input type="text" id="vinculo_empregaticio" name="vinculo_empregaticio"
                    class="w-full p-2 mt-2 border border-gray-400 rounded-lg bg-white focus:bg-gray-100"
                    value="{{($coordenadora->vinculo_empregaticio)}}" readonly>
            </div>
        </div>

        <div class="flex flex-col sm:flex-row justify-center gap-2">
            <a href="{{ route('coordenadoras.editar', $coordenadora->id)}}"
            ...
            <a href="{{ route('professores.listar', $coordenadora->id)}}"
